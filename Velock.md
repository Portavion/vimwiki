...
## DONE
  ...
  * [X] update refresh method for bikepoints (keep in memory and update only what timestamp changes)  #80ea5068
  * [X] add edit button  #43dda00c
  * [X] add modal up / down arrows (ie only in edit mode)  #9095e7e7
  * [X] update refresh to auto add failed / missing bikepoints to db  #dd665963
  * [X] add save button  #4dde5648
